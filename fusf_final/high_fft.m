    ...
    for i = 1:revol_a
        ...
        cutoffFreq = 5; % Example cutoff frequency (Hz)
        ...
        % Apply low-pass filter: zero out frequency components above the cutoff frequency
        high_freq_indices = freqAxis < cutoffFreq;
        fftSpec(high_freq_indices) = 0;
